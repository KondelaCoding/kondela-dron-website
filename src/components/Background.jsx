  ...
  return (
    <div className="aspect-video w-screen relative mt-20">
      ...
      <div className="flex justify-center items-center">
        <h1 className="text-center text-4xl font-black drop-shadow-[10px_10px_10px_rgba(0,0,0,0.5)] uppercase tablet:text-7xl tablet:mt-10 laptop:text-9xl laptop:mt-52 desktop:text-[10rem] desktop:mt-64">
          zmień <br />
          perspektywę
        </h1>
      </div>
